...
then
    wget -q https://oplab9.parqtec.unicamp.br/pub/ppc64el/bazel/ubuntu_${dist_version}/bazel_bin_ppc64le_3.0.0
    sudo mv bazel_bin_ppc64le_3.0.0 /usr/local/bin/bazel
